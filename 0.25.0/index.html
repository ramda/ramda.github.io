...
<pre><code class="lang-html">&lt;script src=&quot;//cdnjs.cloudflare.com/ajax/libs/ramda/0.25.0/ramda.min.js&quot;&gt;&lt;/script&gt;
</code></pre>
<p>or one of the below links from <a href="http://jsdelivr.com">jsDelivr</a>:</p>
<pre><code class="lang-html">&lt;script src=&quot;//cdn.jsdelivr.net/npm/ramda@0.25.1/dist/ramda.min.js&quot;&gt;&lt;/script&gt;
...
</code></pre><p>This requires having Node/io.js installed and ramda&#39;s dependencies installed (just use <code>npm install</code> before running partial build). </p>
...
</code></pre><p>then you can run the tests (and get detailed output) by running:</p>
<pre><code>npm test
